...
class Diferenciales extends StatefulWidget {
  ...
  Diferenciales({Key key}) : super(key: key);
  @override
  _DiferencialesHomeState createState() => _DiferencialesHomeState();
}

class _DiferencialesHomeState extends State<Diferenciales> {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Differentiation'),
      ),
      body: Center(
