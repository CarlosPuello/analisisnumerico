...
class IterativosFront extends StatefulWidget {
  IterativosFront({
    Key key,
  ...
  final String titulo;
  @override
  _IterativosFrontState createState() => _IterativosFrontState();
}

class _IterativosFrontState extends State<IterativosFront> {
  List matriz;
  @override
  void initState() {
